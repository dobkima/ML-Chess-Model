...
@command_component(
    name="start_square_model_training",
    version="1.0.0",
    display_name="Train Start Square Model",
    description="Trains a model to predict the start square of a chess move.",
    environment="conda.yaml"
)
def start_square_model_training(
